...
const Navbar = () => {
    ...
    const short = () => 'hover:bg-gray-200 text-lg text-black font-semibold py-2 block ' ;
    return (
      
        <nav className={`p-2 sticky top-0 z-[20] mx-auto flex justify-around w-full md:w-auto ${scrolled ? 'bg-white' : 'bg-zinc-100'}`}>
...
{/* <nav className="bg-zinc-100 p-2 sticky top-0 z-[20] mx-auto flex justify-around -full md:w-auto">
<div className="container mx-auto flex flex-wrap justify-between items-center">
    <div className="flex-shrink-0">
    <NavLink><img className="h-20 w-auto" src={logo} alt="PiggyVest" /> </NavLink>
    </div>
...
<div className={`py-2 md:flex justify-evenly items-center md:space-x-4 ${isOpen ? 'block text-center' : 'hidden'} w-full md:w-auto `}>
